...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference("Subscription.count") do
      post subscriptions_url, params: { subscription: { issue_id: @subscription.issue_id, user_id: @subscription.user_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { issue_id: @subscription.issue_id, user_id: @subscription.user_id } }
